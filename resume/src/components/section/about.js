              ...
              <div className="timeline">
                <div className="timeline__block">
                  ...
                  <div className="timeline__desc">
                    <p>Development off Games and complete applications, most using the Unity engine, including loading of assets by server (asset bundle). Development and implementation of UI, general UX and plugins for Android and IOs.</p>
                  </div>
